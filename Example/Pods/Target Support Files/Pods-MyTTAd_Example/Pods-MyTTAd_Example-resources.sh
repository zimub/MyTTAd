...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/ThinkingDataCore/ThinkingDataCore.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/ThinkingSDK/ThinkingSDK.bundle"
